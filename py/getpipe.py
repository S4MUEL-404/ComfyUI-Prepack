...
class PrepackGetPipe:
    ...
    RETURN_TYPES = ("MODEL", "CLIP", "VAE", "STRING", "CONDITIONING", "CONDITIONING", "LATENT", "INT", "INT", "FLOAT", "FLOAT")
    RETURN_NAMES = ("model", "clip", "vae", "lora_text", "positive", "negative", "latent_image", "seed", "steps", "cfg", "denoise")
    OUTPUT_TOOLTIPS = (
    ...
    FUNCTION = "get_pipe"
    CATEGORY = "💀Prepack"
    DESCRIPTION = "Unpack a pipe object produced by Prepack_SetPipe into model, clip, vae, lora_text, positive, negative, latent_image, seed, steps, cfg, denoise components. All outputs can be None."
