...
class PrepackSetPipe:
    ...
    def INPUT_TYPES(s):
        return {
            ...
            "optional": {
                ...
                "lora_path": ("STRING", {"tooltip": "The LoRA model path to pack.", "multiline": False, "forceInput": True}),
    ...
    RETURN_TYPES = ("PIPE",)
    RETURN_NAMES = ("pipe",)
    OUTPUT_TOOLTIPS = ("The packed pipeline object containing model, clip, vae, lora_text, lora_path, positive, negative, latent_image, seed, steps, cfg, denoise.",)
    FUNCTION = "set_pipe"
    CATEGORY = "💀Prepack"
    DESCRIPTION = "Pack model, clip, vae, lora_text, lora_path, positive, negative, latent_image, seed, steps, cfg, denoise into a single pipe object. All inputs are optional with default values."

    def set_pipe(self, model=None, clip=None, vae=None, lora_text=None, lora_path=None,
